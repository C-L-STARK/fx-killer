...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    // Donate Page
    'donate.hero.badge': '支持免费培训',
    'donate.hero.title1': '支持',
    'donate.hero.title2': '免费培训',
    'donate.hero.desc': '我们提供完全免费的专业培训服务，您的捐赠将帮助我们持续为更多人提供高质量的培训',
    'donate.hero.stat1': '100%免费',
    'donate.hero.stat2': '系统化培训',
    'donate.hero.stat3': '无偿提供',
    'donate.hero.stat1.value': '0学费',
    'donate.hero.stat2.value': '30天',
    'donate.hero.stat3.value': '持续',

    'donate.amount.badge': '建议捐赠金额',
    ...
    'donate.benefits.title': '我们提供的免费服务',
    'donate.benefits.desc': '完全免费的专业交易员培训体系',
    'donate.benefits.a.title': '系统化培训课程',
    'donate.benefits.a.desc': '30天完整的培训体系，从基础到实战，全部免费提供，无需支付任何学费',
    'donate.benefits.b.title': '专业导师指导',
    'donate.benefits.b.desc': '一对一导师指导，专业教练陪跑，帮助你快速成长，所有服务完全免费',
    'donate.benefits.c.title': '真实资金配置',
    'donate.benefits.c.desc': '通过考核后获得真实资金管理权限，开启职业交易员生涯，无需自己投入资金',

    'donate.rewards.title': '您的捐赠用途',
    'donate.rewards.desc': '帮助我们持续为更多人提供免费培训',
    'donate.rewards.a.title': '维持免费培训',
    'donate.rewards.a.desc': '您的捐赠将用于维持培训平台的运营，确保我们能够持续为更多人提供免费的专业培训服务',
    'donate.rewards.b.title': '改进培训质量',
    'donate.rewards.b.desc': '用于开发更好的培训内容、工具和系统，不断提升培训质量，让更多人受益',

    'donate.how.title': '如何进行捐赠',
    'donate.how.desc': '通过加密货币进行捐赠，支持我们的免费培训事业',
    'donate.how.flow.title': '捐赠流程',
    'donate.how.step1.title': '了解我们的服务',
    'donate.how.step1.desc': '我们提供完全免费的专业交易员培训，无需支付任何学费',
    'donate.how.step2.title': '自愿捐赠',
    'donate.how.step2.desc': '如果您认可我们的免费培训理念，可以通过加密货币进行捐赠',
    'donate.how.step3.title': '获取捐赠地址',
    'donate.how.step3.desc': '邮件联系我们获取 USDT/USDC 捐赠地址',
    'donate.how.step4.title': '完成捐赠',
    ...
    'donate.notice.2': '捐赠不影响培训资格，所有人都可免费参加培训',
    'donate.notice.3': '捐赠将用于维持平台运营和改进培训质量',
    'donate.notice.4': '所有捐赠默认为私人自愿行为，无任何商业承诺',

    'donate.modal.title': '申请免费培训',

    // Donate Page Decorative
    'donate.scroll_unlock': '了解更多',
    'donate.card.core_access': '01 // 免费服务',
    'donate.card.full_privileges': '完整培训权限',
    ...
    'donate.wallet.copy': '点击复制',
    'donate.wallet.copied': '已复制',
    'donate.wallet.loading': '加载中...',
    ...
    'req.system.protocol': '系统协议 v9.0',
    'req.system.analysis': '交易员 DNA 分析',
    'req.system.scanning': '系统正在扫描您的心理特征与行为模式...',
    'req.system.fatal_err': '致命错误',
    'req.system.match_confirmed': '匹配确认',
    'req.system.data_stream': '数据流',

    'req.rejection.title': '系统拒绝标准',
    'req.rejection.fragility': '情绪脆弱',
    'req.rejection.fragility.desc': '无法承受市场波动带来的心理压力',
    'req.rejection.gambler': '赌徒谬误',
    'req.rejection.gambler.desc': '将市场视为博彩游戏而非概率系统',
    'req.rejection.stagnation': '认知停滞',
    'req.rejection.stagnation.desc': '拒绝进化思维模型，固步自封',
    'req.rejection.impulse': '冲动执行',
    'req.rejection.impulse.desc': '缺乏战术耐心，随意破坏交易计划',

    'req.selection.title': '精英操盘手标准',
    'req.selection.discipline': '斯多葛纪律',
    'req.selection.discipline.desc': '对交易系统的绝对服从与执行',
    'req.selection.resilience': '资金韧性',
    'req.selection.resilience.desc': '在回撤期保持冷静与客观的能力',
    'req.selection.precision': '战术精度',
    'req.selection.precision.desc': '如狙击手般精准，零犹豫进出场',
    'req.selection.evolution': '持续进化',
    'req.selection.evolution.desc': '对自我提升的无尽追求与复盘',

    'req.assessment.title': '核心能力指标',
    'req.metric.cognitive': '认知速度',
    'req.metric.pattern': '模式识别',
    'req.metric.tactical': '战术精度',
    'req.metric.psych': '心理装甲',
    'req.metric.mission': '使命契合',
  ...
  en: {
    ...
    // Requirements
    // Candidate Requirements (Redesigned)
    'req.system.protocol': 'System Protocol v9.0',
    'req.system.analysis': 'Trader DNA Analysis',
    'req.system.scanning': 'SYSTEM SCANNING PSYCHOLOGICAL TRAITS AND BEHAVIORAL PATTERNS...',
    'req.system.fatal_err': 'FATAL_ERR',
    'req.system.match_confirmed': 'MATCH_CONFIRMED',
    'req.system.data_stream': 'DATA_STREAM',

    'req.rejection.title': 'SYSTEM REJECTION CRITERIA',
    'req.rejection.fragility': 'Emotional Fragility',
    'req.rejection.fragility.desc': 'Unable to withstand psychological pressure of market volatility',
    'req.rejection.gambler': 'Gambler\'s Fallacy',
    'req.rejection.gambler.desc': 'Treating the market as a game of chance rather than a probability system',
    'req.rejection.stagnation': 'Cognitive Stagnation',
    'req.rejection.stagnation.desc': 'Refusal to evolve mental models, stuck in old ways',
    'req.rejection.impulse': 'Impulsive Execution',
    'req.rejection.impulse.desc': 'Lacking strategic patience, violating trading plans',

    'req.selection.title': 'ELITE OPERATOR STANDARDS',
    'req.selection.discipline': 'Stoic Discipline',
    'req.selection.discipline.desc': 'Absolute obedience and execution of the trading system',
    'req.selection.resilience': 'Financial Resilience',
    'req.selection.resilience.desc': 'Ability to remain calm and objective during drawdowns',
    'req.selection.precision': 'Tactical Precision',
    'req.selection.precision.desc': 'Sniper-like accuracy, zero hesitation in entry and exit',
    'req.selection.evolution': 'Continuous Evolution',
    'req.selection.evolution.desc': 'Relentless pursuit of self-improvement and review',

    'req.assessment.title': 'CORE COMPETENCY METRICS',
    'req.metric.cognitive': 'Cognitive Velocity',
    'req.metric.pattern': 'Pattern Recognition',
    'req.metric.tactical': 'Tactical Precision',
    'req.metric.psych': 'Psychological Armor',
    'req.metric.mission': 'Mission Alignment',
    ...
    'cta.subtitle': 'Time is the only cost, elimination is the greatest risk. Ready? Schedule interview. Pass and enter training.',
    ...
    'cta.elimination.title': 'Elimination',
    ...
    // Donate Page
    'donate.hero.badge': 'SUPPORT FREE TRAINING',
    'donate.hero.title1': 'Support',
    'donate.hero.title2': 'Free Training',
    'donate.hero.desc': 'We provide completely free professional training services. Your donation helps us continue providing high-quality training for more people',
    'donate.hero.stat1': '100% Free',
    'donate.hero.stat2': 'Systematic Training',
    'donate.hero.stat3': 'No Cost',
    'donate.hero.stat1.value': '$0 Tuition',
    'donate.hero.stat2.value': '30 Days',
    'donate.hero.stat3.value': 'Ongoing',

    'donate.amount.badge': 'Suggested Donation Amount',
    ...
    'donate.benefits.title': 'Our Free Services',
    'donate.benefits.desc': 'Completely free professional trader training system',
    'donate.benefits.a.title': 'Systematic Training Courses',
    'donate.benefits.a.desc': 'Complete 30-day training system, from basics to live trading, all provided free of charge, no tuition fees required',
    'donate.benefits.b.title': 'Professional Mentor Guidance',
    'donate.benefits.b.desc': 'One-on-one mentor guidance, professional coaching support, help you grow fast, all services completely free',
    'donate.benefits.c.title': 'Real Capital Allocation',
    'donate.benefits.c.desc': 'Get real capital management rights after passing assessment, start professional trading career, no need to invest your own capital',

    'donate.rewards.title': 'How Your Donation Helps',
    'donate.rewards.desc': 'Help us continue providing free training for more people',
    'donate.rewards.a.title': 'Maintain Free Training',
    'donate.rewards.a.desc': 'Your donation will be used to maintain the training platform operations, ensuring we can continue providing free professional training services for more people',
    'donate.rewards.b.title': 'Improve Training Quality',
    'donate.rewards.b.desc': 'Used to develop better training content, tools and systems, continuously improve training quality, benefit more people',

    'donate.how.title': 'How to Donate',
    'donate.how.desc': 'Donate via cryptocurrency to support our free training mission',
    'donate.how.flow.title': 'Donation Process',
    'donate.how.step1.title': 'Learn About Our Services',
    'donate.how.step1.desc': 'We provide completely free professional trader training, no tuition fees required',
    'donate.how.step2.title': 'Voluntary Donation',
    'donate.how.step2.desc': 'If you support our free training philosophy, you can donate via cryptocurrency',
    'donate.how.step3.title': 'Get Donation Address',
    'donate.how.step3.desc': 'Email us to get USDT/USDC donation address',
    ...
    'donate.notice.2': 'Donations do not affect training eligibility, everyone can participate in training for free',
    'donate.notice.3': 'Donations will be used to maintain platform operations and improve training quality',
    'donate.notice.4': 'All donations are considered private voluntary actions with no commercial commitments',

    'donate.modal.title': 'Apply for Free Training',

    // Donate Page Decorative
    'donate.scroll_unlock': 'Learn More',
    'donate.card.core_access': '01 // Free Services',
    'donate.card.full_privileges': 'Complete Training Access',
    'donate.card.exclusive': '02 // Support Us',
    'donate.card.community': '03 // Community Contribution',
    'donate.card.bonus_rewards': 'Help More People',
    'donate.membership.label': 'Training Eligibility',
    'donate.membership.title': 'Free Training',
    'donate.price.label': 'Suggested Donation',
    'donate.price.daily': '+ $5.00 / day',
    'donate.wallet.label': 'Wallet Address (USDT/USDC)',
    'donate.wallet.copy': 'Click to Copy',
    'donate.wallet.copied': 'Copied',
    'donate.wallet.loading': 'Loading...',

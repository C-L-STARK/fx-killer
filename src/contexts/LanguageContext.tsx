...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'donate.scroll_unlock': '滑动解锁',
    'donate.card.core_access': '01 // 核心权限',
    'donate.card.full_privileges': '完整系统权限',
    'donate.card.exclusive': '02 // 尊享权益',
    'donate.card.community': '03 // 社区权限',
    'donate.card.bonus_rewards': '额外奖励',
    'donate.membership.label': '会员资格',
    'donate.membership.title': '通行证',
    'donate.price.label': '当前入场价格',
  ...
  en: {
    ...
    // Donate Page Decorative
    'donate.scroll_unlock': 'Scroll to Unlock',
    'donate.card.core_access': '01 // Core Access',
    'donate.card.full_privileges': 'Full System Privileges',
    'donate.card.exclusive': '02 // Exclusive',
    'donate.card.community': '03 // Community',
    'donate.card.bonus_rewards': 'Bonus Rewards',
    'donate.membership.label': 'The Membership',
    'donate.membership.title': 'Access Pass',
    'donate.price.label': 'Current Entry Price',

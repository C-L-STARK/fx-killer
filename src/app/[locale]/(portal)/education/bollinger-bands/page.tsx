    ...
    <EducationPageTemplate content={content} language={lang}>
      ...
      <section id="what-is-bb" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '布林带的三个组成部分' : 'Bollinger Bands Three Components'}</h3>
            <ul className="space-y-3">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 中轨（Middle Band）：' : '1. Middle Band:'}</strong>{' '}
                {isZh
                  ? '通常为20周期简单移动平均线（SMA），代表价格的中心趋势'
                  : 'Usually 20-period Simple Moving Average (SMA), represents central price trend'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 上轨（Upper Band）：' : '2. Upper Band:'}</strong>{' '}
                {isZh
                  ? '中轨 + (2倍标准差)，代表价格的上方阻力区域'
                  : 'Middle Band + (2 × Standard Deviation), represents upper resistance zone'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 下轨（Lower Band）：' : '3. Lower Band:'}</strong>{' '}
                {isZh
          ...
          <div className="p-6 bg-gray-50 dark:bg-[#0a0a0a] border-2 border-gray-800 dark:border-gray-700">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '动态适应性：' : 'Dynamic adaptability:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '多功能应用：' : 'Multi-functional:'}</strong>{' '}
                {isZh ? '可用于趋势识别、支撑阻力、超买超卖、突破交易' : 'Used for trend identification, support/resistance, overbought/oversold, breakout trading'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '波动性测量：' : 'Volatility measurement:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '视觉直观：' : 'Visual clarity:'}</strong>{' '}
                {isZh ? '价格与上下轨的关系一目了然，易于理解和应用' : 'Price relationship with bands clear at a glance, easy to understand and apply'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '统计基础：' : 'Statistical foundation:'}</strong>{' '}
      ...
      <section id="calculation" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-300 dark:text-gray-300 leading-relaxed">
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '计算公式' : 'Calculation Formulas'}</h3>
            <div className="space-y-3 font-mono text-sm">
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 计算中轨（20周期SMA）：' : '1. Calculate Middle Band (20-period SMA):'}</strong>
              </p>
              <p className="pl-4">
                {isZh ? '中轨 = SMA(收盘价, 20)' : 'Middle Band = SMA(Close, 20)'}
              </p>
              <p className="mt-3">
                <strong className="text-white">{isZh ? '2. 计算标准差（Standard Deviation）：' : '2. Calculate Standard Deviation:'}</strong>
              </p>
              <p className="pl-4">
                {isZh ? 'σ = SQRT(SUM[(价格 - 中轨)² ] / 20)' : 'σ = SQRT(SUM[(Price - Middle Band)²] / 20)'}
              </p>
              <p className="mt-3">
                <strong className="text-white">{isZh ? '3. 计算上轨：' : '3. Calculate Upper Band:'}</strong>
              </p>
              <p className="pl-4">
                {isZh ? '上轨 = 中轨 + (2 × σ)' : 'Upper Band = Middle Band + (2 × σ)'}
              </p>
              <p className="mt-3">
                <strong className="text-white">{isZh ? '4. 计算下轨：' : '4. Calculate Lower Band:'}</strong>
              </p>
              <p className="pl-4">
                {isZh ? '下轨 = 中轨 - (2 × σ)' : 'Lower Band = Middle Band - (2 × σ)'}
              </p>
              <p className="mt-3 text-white/80 dark:text-gray-300/80">
              ...
              <table className="w-full border-2 border-gray-800">
                ...
                <tbody className="text-sm text-gray-300">
                  <tr className="border border-gray-800">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">(20, 2)</td>
                  ...
                  <tr className="bg-gray-50 dark:bg-[#0a0a0a] border border-gray-800">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">(20, 2.5)</td>
                    <td className="border border-gray-800 p-3 text-gray-300">
                  ...
                  <tr className="border border-gray-800">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">(20, 1.5)</td>
                    <td className="border border-gray-800 p-3 text-gray-300">
                  ...
                  <tr className="bg-gray-50 dark:bg-[#0a0a0a] border border-gray-800">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">(10, 2)</td>
                    <td className="border border-gray-800 p-3 text-gray-300">
                  ...
                  <tr className="border border-gray-800">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">(50, 2.5)</td>
                    <td className="border border-gray-800 p-3 text-gray-300">
      ...
      <section id="interpretation" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-300 dark:text-gray-300 leading-relaxed">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-gray-300">
                  <strong className="text-white">{isZh ? '震荡市中：' : 'In ranging markets:'}</strong>{' '}
                  {isZh ? '触及下轨是强支撑，高概率反弹，可做多' : 'Lower band touch is strong support, high probability bounce, can long'}
                </p>
                <p className="text-gray-300">
                  <strong className="text-white">{isZh ? '下降趋势中：' : 'In downtrends:'}</strong>{' '}
            ...
            <div className="p-6 border-2 border-red-600 bg-red-50 dark:bg-red-900/20">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">{isZh ? '上升趋势中：' : 'In uptrends:'}</strong>{' '}
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '布林带宽度（Bandwidth）的意义' : 'Bollinger Bandwidth Significance'}</h3>
            <p className="mb-3">
              {isZh
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '带宽扩张（Expansion）：' : 'Bandwidth Expansion:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '带宽收缩（Contraction）：' : 'Bandwidth Contraction:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '布林带挤压（Squeeze）：' : 'Bollinger Squeeze:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '带宽正常：' : 'Normal Bandwidth:'}</strong>{' '}
                {isZh
                  ? '市场处于正常波动状态，按常规策略交易。'
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '价格在中轨上方运行：' : 'Price running above middle band:'}</strong>{' '}
                {isZh ? '市场处于上升趋势，买盘强劲。中轨可作为动态支撑。' : 'Market in uptrend, strong buying pressure. Middle band can act as dynamic support.'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '价格在中轨下方运行：' : 'Price running below middle band:'}</strong>{' '}
                {isZh ? '市场处于下降趋势，卖盘强劲。中轨可作为动态阻力。' : 'Market in downtrend, strong selling pressure. Middle band can act as dynamic resistance.'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '价格穿越中轨：' : 'Price crossing middle band:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '价格频繁穿越中轨：' : 'Price frequently crossing middle band:'}</strong>{' '}
        ...
        <div className="space-y-6">
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '做多设置：' : 'Long Setup:'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li className="text-gray-300">{isZh ? '市场环境：震荡市，无明确趋势（价格在中轨上下频繁穿越）' : 'Market context: ranging market, no clear trend (price frequently crossing middle band)'}</li>
                  <li className="text-gray-300">{isZh ? '价格触及或穿透布林带下轨' : 'Price touches or penetrates lower band'}</li>
                  <li className="text-gray-300">{isZh ? '出现看涨反转K线形态（如Pin Bar、锤子线）' : 'Bullish reversal candlestick appears (e.g., Pin Bar, hammer)'}</li>
                  <li className="text-gray-300">{isZh ? 'RSI超卖（<30）可提高信号质量' : 'RSI oversold (<30) improves signal quality'}</li>
                  <li className="text-gray-300">{isZh ? '入场：下一根K线开盘价' : 'Entry: next candle open price'}</li>
                  <li className="text-gray-300">{isZh ? '止损：下轨下方20-30点，或最近低点下方' : 'Stop: 20-30 pips below lower band, or below recent low'}</li>
                  <li className="text-gray-300">{isZh ? '止盈：中轨附近，或风险回报比1:2' : 'Target: near middle band, or 1:2 risk-reward ratio'}</li>
                </ul>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a] mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '做空设置：' : 'Short Setup:'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li className="text-gray-300">{isZh ? '市场环境：震荡市，无明确趋势' : 'Market context: ranging market, no clear trend'}</li>
                  <li className="text-gray-300">{isZh ? '价格触及或穿透布林带上轨' : 'Price touches or penetrates upper band'}</li>
                  <li className="text-gray-300">{isZh ? '出现看跌反转K线形态（如射击之星、倒锤子）' : 'Bearish reversal candlestick appears (e.g., shooting star, inverted hammer)'}</li>
                  <li className="text-gray-300">{isZh ? 'RSI超买（>70）可提高信号质量' : 'RSI overbought (>70) improves signal quality'}</li>
                  <li className="text-gray-300">{isZh ? '入场：下一根K线开盘价' : 'Entry: next candle open price'}</li>
                  <li className="text-gray-300">{isZh ? '止损：上轨上方20-30点，或最近高点上方' : 'Stop: 20-30 pips above upper band, or above recent high'}</li>
                  <li className="text-gray-300">{isZh ? '止盈：中轨附近，或风险回报比1:2' : 'Target: near middle band, or 1:2 risk-reward ratio'}</li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li className="text-gray-300">{isZh ? '市场环境：明确上升趋势（价格持续在中轨上方）' : 'Market context: clear uptrend (price consistently above middle band)'}</li>
                  <li className="text-gray-300">{isZh ? '价格突破布林带上轨，收盘价在上轨上方' : 'Price breaks above upper band, close above upper band'}</li>
                  <li className="text-gray-300">{isZh ? '带宽扩张，表明波动性增加，趋势加速' : 'Bandwidth expanding, indicating increased volatility, trend acceleration'}</li>
                  <li className="text-gray-300">{isZh ? '配合成交量放大（如有成交量数据）' : 'Accompanied by volume increase (if volume data available)'}</li>
                  <li className="text-gray-300">{isZh ? '入场：突破确认后的第一个回调至上轨或中轨' : 'Entry: first pullback to upper band or middle band after breakout confirmation'}</li>
                  <li className="text-gray-300">{isZh ? '止损：中轨下方，或最近低点下方' : 'Stop: below middle band, or below recent low'}</li>
                  <li className="text-gray-300">{isZh ? '止盈：追踪止盈，或使用风险回报比2:1或3:1' : 'Target: trailing stop, or use 2:1 or 3:1 risk-reward ratio'}</li>
                </ul>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a] mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '向下突破做空：' : 'Downward Breakout Short:'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li className="text-gray-300">{isZh ? '市场环境：明确下降趋势（价格持续在中轨下方）' : 'Market context: clear downtrend (price consistently below middle band)'}</li>
                  <li className="text-gray-300">{isZh ? '价格跌破布林带下轨，收盘价在下轨下方' : 'Price breaks below lower band, close below lower band'}</li>
                  <li className="text-gray-300">{isZh ? '带宽扩张，趋势加速' : 'Bandwidth expanding, trend acceleration'}</li>
                  <li className="text-gray-300">{isZh ? '配合成交量放大' : 'Accompanied by volume increase'}</li>
                  <li className="text-gray-300">{isZh ? '入场：突破确认后的第一个反弹至下轨或中轨' : 'Entry: first bounce to lower band or middle band after breakout confirmation'}</li>
                  <li className="text-gray-300">{isZh ? '止损：中轨上方，或最近高点上方' : 'Stop: above middle band, or above recent high'}</li>
                  <li className="text-gray-300">{isZh ? '止盈：追踪止盈，或使用风险回报比2:1或3:1' : 'Target: trailing stop, or use 2:1 or 3:1 risk-reward ratio'}</li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '挤压识别与入场：' : 'Squeeze Identification and Entry:'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li className="text-gray-300">{isZh ? '带宽收窄至近期最低水平（可用带宽指标量化）' : 'Bandwidth narrows to recent lowest level (can quantify with bandwidth indicator)'}</li>
                  <li className="text-gray-300">{isZh ? '价格在窄幅区间内震荡，上下轨几乎平行' : 'Price oscillating in narrow range, upper and lower bands nearly parallel'}</li>
                  <li className="text-gray-300">{isZh ? '等待价格突破上轨（做多）或跌破下轨（做空）' : 'Wait for price to break above upper band (long) or below lower band (short)'}</li>
                  <li className="text-gray-300">{isZh ? '突破必须伴随带宽扩张和收盘价确认' : 'Breakout must be accompanied by bandwidth expansion and close confirmation'}</li>
                  <li className="text-gray-300">{isZh ? '入场：突破K线收盘后，或回测突破点时' : 'Entry: after breakout candle closes, or on retest of breakout point'}</li>
                  <li className="text-gray-300">{isZh ? '止损：挤压区间的相反边界（上轨突破止损设在下轨）' : 'Stop: opposite boundary of squeeze range (upper breakout stop at lower band)'}</li>
                  <li className="text-gray-300">{isZh ? '止盈：测算移动距离=挤压区间高度的2-3倍' : 'Target: projected move = 2-3x squeeze range height'}</li>
                </ul>
              </div>
      ...
      <section id="advanced-techniques" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-300 dark:text-gray-300 leading-relaxed">
          <div className="p-6 border-2 border-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '应用1：' : 'Application 1:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '应用2：' : 'Application 2:'}</strong>{' '}
                {isZh
                  ? '突破外层带=强趋势；回测内层带=加仓点'
                  : 'Breaking outer band = strong trend; retesting inner band = add-on point'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '应用3：' : 'Application 3:'}</strong>{' '}
                {isZh
                  ? '内外层带同时收窄=超级挤压，爆发力更强'
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">%B = 1：</strong>{' '}
                {isZh ? '价格位于上轨' : 'Price at upper band'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">%B = 0：</strong>{' '}
                {isZh ? '价格位于下轨' : 'Price at lower band'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">%B = 0.5：</strong>{' '}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-gray-800">
              ...
              <ul className="list-disc pl-6 space-y-2 text-sm">
                <li className="text-gray-300">{isZh ? '关键支撑位 + 布林带下轨 = 双重支撑，强反弹点' : 'Key support + BB lower band = double support, strong bounce point'}</li>
                <li className="text-gray-300">{isZh ? '关键阻力位 + 布林带上轨 = 双重阻力，强回落点' : 'Key resistance + BB upper band = double resistance, strong pullback point'}</li>
                <li className="text-gray-300">{isZh ? '突破阻力 + 布林带扩张 = 有效突破确认' : 'Break resistance + BB expansion = valid breakout confirmation'}</li>
              </ul>
            </div>
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <ul className="list-disc pl-6 space-y-2 text-sm">
                <li className="text-gray-300">{isZh ? '布林带识别价格位置，MACD确认趋势动能' : 'BB identifies price position, MACD confirms trend momentum'}</li>
                <li className="text-gray-300">{isZh ? '价格触及上轨 + MACD死叉 = 强做空' : 'Price at upper band + MACD death cross = strong short'}</li>
                <li className="text-gray-300">{isZh ? '价格触及下轨 + MACD金叉 = 强做多' : 'Price at lower band + MACD golden cross = strong long'}</li>
                <li className="text-gray-300">{isZh ? '布林带挤压 + MACD柱状图扩大 = 突破方向确认' : 'BB squeeze + MACD histogram expansion = breakout direction confirmation'}</li>
              </ul>
            </div>
          </div>
        </div>

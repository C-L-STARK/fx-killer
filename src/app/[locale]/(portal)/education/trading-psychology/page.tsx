      ...
      <section id="why-psychology-matters" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '为什么心理因素决定成败？' : 'Why Psychological Factors Determine Success/Failure?'}</h3>
            <ul className="space-y-3">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 市场是情绪的战场：' : '1. Market is Emotional Battlefield:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 技术分析人人可学，心理控制难以掌握：' : '2. Technical Analysis Anyone Can Learn, Psychological Control Hard to Master:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 小错误的累积效应：' : '3. Cumulative Effect of Small Errors:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 市场会放大你的性格缺陷：' : '4. Market Amplifies Your Character Flaws:'}</strong>{' '}
                {isZh
              ...
              <table className="w-full border-2 border-gray-800 text-sm">
                <thead>
                  <tr className="bg-gray-900 text-gray-300">
                    ...
                    <th className="border border-gray-800 p-3 text-left">{isZh ? '业余交易者' : 'Amateur Trader'}</th>
                    <th className="border border-gray-800 p-3 text-left">{isZh ? '职业交易者' : 'Professional Trader'}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">{isZh ? '连续3次止损' : '3 Consecutive Stops'}</td>
                    <td className="border border-gray-800 p-3 text-red-600 dark:text-red-400">
                      {isZh ? '愤怒、不甘心，加大仓位想回本' : 'Angry, unwilling, increase position to recover'}
                    </td>
                    <td className="border border-gray-800 p-3 text-green-600 dark:text-green-400">
                      {isZh ? '冷静，检查策略，必要时减仓或暂停' : 'Calm, check strategy, reduce position or pause if needed'}
                    </td>
                  </tr>
                  <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">{isZh ? '错过大行情' : 'Miss Big Move'}</td>
                    <td className="border border-gray-800 p-3 text-red-600 dark:text-red-400">
                  ...
                  <tr>
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">{isZh ? '盈利单接近止盈' : 'Profit Near Target'}</td>
                    <td className="border border-gray-800 p-3 text-red-600 dark:text-red-400">
                  ...
                  <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">{isZh ? '亏损单接近止损' : 'Loss Near Stop'}</td>
                    <td className="border border-gray-800 p-3 text-red-600 dark:text-red-400">
                  ...
                  <tr>
                    <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">{isZh ? '达到每日盈利目标' : 'Reach Daily Profit Target'}</td>
                    <td className="border border-gray-800 p-3 text-red-600 dark:text-red-400">

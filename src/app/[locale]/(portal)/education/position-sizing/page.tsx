      ...
      <section id="what-is-position-sizing" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '仓位控制的重要性' : 'Importance of Position Sizing'}</h3>
            <ul className="space-y-3">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 风险控制的最后防线：' : '1. Last Line of Risk Control:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 复利增长的基础：' : '2. Foundation of Compound Growth:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 心理压力管理：' : '3. Psychological Pressure Management:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 策略表现评估：' : '4. Strategy Performance Evaluation:'}</strong>{' '}
                {isZh
          ...
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-300 dark:text-gray-300 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '过大仓位：' : 'Oversized Position:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '过小仓位：' : 'Undersized Position:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '随意调整：' : 'Random Adjustment:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '忽视波动性：' : 'Ignoring Volatility:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '基于保证金而非风险：' : 'Based on Margin Not Risk:'}</strong>{' '}
        ...
        <div className="space-y-6">
          <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="p-4 bg-gray-900 text-gray-300 text-center font-mono text-lg mb-4">
                {isZh
                  ? '手数 = (账户净值 × 风险%) / (止损点数 × 每点价值)'
                  : 'Lot Size = (Account Equity × Risk %) / (Stop Pips × Pip Value)'}
              </div>
              <div className="space-y-3 text-sm">
                <p className="text-gray-300"><strong className="text-white">{isZh ? '公式要素解释：' : 'Formula Components:'}</strong></p>
                <ul className="list-disc pl-6 space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '账户净值：' : 'Account Equity:'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '风险%：' : 'Risk %:'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '止损点数：' : 'Stop Pips:'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '每点价值：' : 'Pip Value:'}</strong>{' '}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-2 text-sm text-gray-300 dark:text-gray-300">
                <div className="p-3 bg-gray-50 dark:bg-[#0a0a0a]">
                  <p className="font-bold mb-2 text-white">{isZh ? '交易参数：' : 'Trade Parameters:'}</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '账户净值：$10,000' : 'Account Equity: $10,000'}</li>
                    <li className="text-gray-300">{isZh ? '风险设置：2%' : 'Risk Setting: 2%'}</li>
                    <li className="text-gray-300">{isZh ? '货币对：EUR/USD' : 'Pair: EUR/USD'}</li>
                    <li className="text-gray-300">{isZh ? '入场价：1.0850' : 'Entry: 1.0850'}</li>
                    <li className="text-gray-300">{isZh ? '止损价：1.0820（30点）' : 'Stop: 1.0820 (30 pips)'}</li>
                    <li className="text-gray-300">{isZh ? '每点价值：$10（标准手）' : 'Pip Value: $10 (standard lot)'}</li>
                  </ul>
                </div>
                <div className="p-3 bg-gray-900 text-gray-300 font-mono text-xs">
                  <p className="mb-2">{isZh ? '计算过程：' : 'Calculation:'}</p>
                  <p className="text-gray-300">Risk = $10,000 × 2% = $200</p>
                  <p className="text-gray-300">Lot = $200 / (30 × $10)</p>
                  <p className="text-gray-300">Lot = $200 / $300</p>
                  <p className="font-bold mt-1 text-white">= 0.67 lots</p>
                </div>
                <p className="mt-2">
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-2 text-sm text-gray-300 dark:text-gray-300">
                <div className="p-3 bg-gray-50 dark:bg-[#0a0a0a]">
                  <p className="font-bold mb-2 text-white">{isZh ? '交易参数：' : 'Trade Parameters:'}</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '账户净值：$5,000' : 'Account Equity: $5,000'}</li>
                    <li className="text-gray-300">{isZh ? '风险设置：1.5%' : 'Risk Setting: 1.5%'}</li>
                    <li className="text-gray-300">{isZh ? '货币对：GBP/JPY' : 'Pair: GBP/JPY'}</li>
                    <li className="text-gray-300">{isZh ? '入场价：185.50' : 'Entry: 185.50'}</li>
                    <li className="text-gray-300">{isZh ? '止损价：184.70（80点）' : 'Stop: 184.70 (80 pips)'}</li>
                    <li className="text-gray-300">{isZh ? '每点价值：约$6.5（标准手）' : 'Pip Value: ~$6.5 (standard lot)'}</li>
                  </ul>
                </div>
                <div className="p-3 bg-gray-900 text-gray-300 font-mono text-xs">
                  <p className="mb-2">{isZh ? '计算过程：' : 'Calculation:'}</p>
                  <p className="text-gray-300">Risk = $5,000 × 1.5% = $75</p>
                  <p className="text-gray-300">Lot = $75 / (80 × $6.5)</p>
                  <p className="text-gray-300">Lot = $75 / $520</p>
                  <p className="font-bold mt-1 text-white">= 0.14 lots</p>
                </div>
                <p className="mt-2">
                  <strong className="text-white">{isZh ? '结论：' : 'Conclusion:'}</strong>{' '}
                  {isZh
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-2 border-gray-800 text-sm">
                <thead>
                  <tr className="bg-gray-50 dark:bg-black text-white">
                    <th className="border border-gray-800 p-3 text-left">{isZh ? '账户规模' : 'Account Size'}</th>
                    <th className="border border-gray-800 p-3 text-left">{isZh ? '建议风险%' : 'Recommended Risk %'}</th>
                    <th className="border border-gray-800 p-3 text-left">{isZh ? '单笔风险金额' : 'Risk Per Trade'}</th>
                    <th className="border border-gray-800 p-3 text-left">{isZh ? '原因' : 'Reason'}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-800 p-3">$500-1,000</td>
                    <td className="border border-gray-800 p-3 font-bold text-white">1-2%</td>
                    <td className="border border-gray-800 p-3">$5-20</td>
                    <td className="border border-gray-800 p-3">
                      {isZh ? '小资金需保守，允许更多错误' : 'Small capital needs conservatism, allow more mistakes'}
                    </td>
                  </tr>
                  <tr className="bg-white/10">
                    <td className="border border-gray-800 p-3">$1,000-5,000</td>
                    <td className="border border-gray-800 p-3 font-bold text-white">1.5-2%</td>
                    <td className="border border-gray-800 p-3">$15-100</td>
                    <td className="border border-gray-800 p-3">
                      {isZh ? '标准设置，平衡增长与风险' : 'Standard setting, balance growth and risk'}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-800 p-3">$5,000-20,000</td>
                    <td className="border border-gray-800 p-3 font-bold text-white">2%</td>
                    <td className="border border-gray-800 p-3">$100-400</td>
                    <td className="border border-gray-800 p-3">
                      {isZh ? '职业交易者标准设置' : 'Professional trader standard'}
                    </td>
                  </tr>
                  <tr className="bg-white/10">
                    <td className="border border-gray-800 p-3">$20,000+</td>
                    <td className="border border-gray-800 p-3 font-bold text-white">1.5-2.5%</td>
                    <td className="border border-gray-800 p-3">$300+</td>
                    <td className="border border-gray-800 p-3">
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <ul className="space-y-2 text-gray-300 dark:text-gray-300 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 自动复利增长：' : '1. Automatic Compound Growth:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 风险自动递减：' : '2. Risk Automatically Decreases:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 简单易执行：' : '3. Simple to Execute:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 心理压力可控：' : '4. Controllable Psychological Pressure:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '5. 适应所有策略：' : '5. Adapts to All Strategies:'}</strong>{' '}
        ...
        <div className="space-y-6">
          <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-3 text-sm">
                <p className="text-gray-300"><strong className="text-white">{isZh ? '公式解释：' : 'Formula Explanation:'}</strong></p>
                <ul className="list-disc pl-6 space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">K</strong> = {isZh ? '凯利百分比（应投入的资金比例）' : 'Kelly percentage (proportion of capital to invest)'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">W</strong> = {isZh ? '胜率（盈利交易占比）' : 'Win rate (proportion of winning trades)'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">B</strong> = {isZh ? '盈亏比（平均盈利 / 平均亏损）' : 'Profit/loss ratio (average win / average loss)'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">L</strong> = {isZh ? '失败率（1 - W）' : 'Loss rate (1 - W)'}
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
              ...
              <div className="space-y-2 text-sm text-gray-300 dark:text-gray-300">
                <p className="font-bold text-white">{isZh ? '策略统计数据（100笔交易）：' : 'Strategy Statistics (100 trades):'}</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">{isZh ? '盈利交易：42笔' : 'Winning trades: 42'}</li>
                  <li className="text-gray-300">{isZh ? '亏损交易：58笔' : 'Losing trades: 58'}</li>
                  <li className="text-gray-300">{isZh ? '胜率（W）：42% = 0.42' : 'Win rate (W): 42% = 0.42'}</li>
                  <li className="text-gray-300">{isZh ? '平均盈利：$450' : 'Average win: $450'}</li>
                  <li className="text-gray-300">{isZh ? '平均亏损：$180' : 'Average loss: $180'}</li>
                  <li className="text-gray-300">{isZh ? '盈亏比（B）：$450/$180 = 2.5' : 'Profit/loss ratio (B): $450/$180 = 2.5'}</li>
                </ul>
                <div className="p-3 bg-gray-50 dark:bg-black text-white font-mono text-xs mt-2">
                  <p className="mb-2">{isZh ? '凯利计算：' : 'Kelly Calculation:'}</p>
                  <p className="text-gray-300">K = (0.42 × 2.5 - 0.58) / 2.5</p>
                  <p className="text-gray-300">K = (1.05 - 0.58) / 2.5</p>
                  <p className="text-gray-300">K = 0.47 / 2.5</p>
                  <p className="font-bold mt-1 text-white">K = 0.188 = 18.8%</p>
                </div>
                <p className="mt-2">
                  <strong className="text-white">{isZh ? '结论：' : 'Conclusion:'}</strong>{' '}
                  {isZh
            ...
            <div className="p-6 border-2 border-red-600 bg-red-50 dark:bg-red-900/20">
              ...
              <div className="space-y-2 text-sm text-gray-300 dark:text-gray-300">
                <p className="font-bold text-white">{isZh ? '策略统计数据（150笔交易）：' : 'Strategy Statistics (150 trades):'}</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">{isZh ? '盈利交易：75笔' : 'Winning trades: 75'}</li>
                  <li className="text-gray-300">{isZh ? '亏损交易：75笔' : 'Losing trades: 75'}</li>
                  <li className="text-gray-300">{isZh ? '胜率（W）：50% = 0.50' : 'Win rate (W): 50% = 0.50'}</li>
                  <li className="text-gray-300">{isZh ? '平均盈利：$300' : 'Average win: $300'}</li>
                  <li className="text-gray-300">{isZh ? '平均亏损：$200' : 'Average loss: $200'}</li>
                  <li className="text-gray-300">{isZh ? '盈亏比（B）：$300/$200 = 1.5' : 'Profit/loss ratio (B): $300/$200 = 1.5'}</li>
                </ul>
                <div className="p-3 bg-gray-50 dark:bg-black text-white font-mono text-xs mt-2">
                  <p className="mb-2">{isZh ? '凯利计算：' : 'Kelly Calculation:'}</p>
                  <p className="text-gray-300">K = (0.50 × 1.5 - 0.50) / 1.5</p>
                  <p className="text-gray-300">K = (0.75 - 0.50) / 1.5</p>
                  <p className="text-gray-300">K = 0.25 / 1.5</p>
                  <p className="font-bold mt-1 text-white">K = 0.167 = 16.7%</p>
                </div>
                <p className="mt-2">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm">
              <div className="p-4 border-2 border-gray-800">
                <p className="font-bold mb-2 text-white">{isZh ? '1. 永远不要使用完全凯利（Full Kelly）' : '1. Never Use Full Kelly'}</p>
                <p className="text-gray-300">
                  {isZh
              ...
              <div className="p-4 border-2 border-gray-800">
                <p className="font-bold mb-2 text-white">{isZh ? '2. 推荐使用半凯利或1/4凯利' : '2. Recommend Half-Kelly or 1/4-Kelly'}</p>
                <p className="text-gray-300">
                  {isZh
              ...
              <div className="p-4 border-2 border-gray-800">
                <p className="font-bold mb-2 text-white">{isZh ? '3. 需要至少100笔交易数据' : '3. Need At Least 100 Trade Data'}</p>
                <p className="text-gray-300">
                  {isZh
              ...
              <div className="p-4 border-2 border-gray-800">
                <p className="font-bold mb-2 text-white">{isZh ? '4. 定期重新计算（每季度）' : '4. Recalculate Regularly (Quarterly)'}</p>
                <p className="text-gray-300">
                  {isZh
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-2 border-yellow-600 text-sm">
                ...
                <tbody className="text-gray-300 dark:text-gray-300">
                  <tr>
                    <td className="border border-yellow-600 p-3 font-bold text-white">{isZh ? '难度' : 'Difficulty'}</td>
                  ...
                  <tr className="bg-yellow-50 dark:bg-yellow-900/10">
                    <td className="border border-yellow-600 p-3 font-bold text-white">{isZh ? '数据要求' : 'Data Requirement'}</td>
                  ...
                  <tr>
                    <td className="border border-yellow-600 p-3 font-bold text-white">{isZh ? '增长速度' : 'Growth Speed'}</td>
                  ...
                  <tr className="bg-yellow-50 dark:bg-yellow-900/10">
                    <td className="border border-yellow-600 p-3 font-bold text-white">{isZh ? '波动性' : 'Volatility'}</td>
                  ...
                  <tr>
                    <td className="border border-yellow-600 p-3 font-bold text-white">{isZh ? '适用对象' : 'Suitable For'}</td>
                  ...
                  <tr className="bg-yellow-50 dark:bg-yellow-900/10">
                    <td className="border border-yellow-600 p-3 font-bold text-white">{isZh ? '推荐风险' : 'Recommended Risk'}</td>
            ...
            <p className="mt-3 text-gray-300 dark:text-gray-300 text-sm">
              {isZh
      ...
      <section id="dynamic-sizing" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                  <p className="font-bold mb-2 text-white">{isZh ? '计算公式：' : 'Calculation Formula:'}</p>
                  <div className="font-mono text-xs bg-gray-900 text-gray-300 p-3 mb-2">
                    {isZh
                      ? '调整因子 = 基准ATR / 当前ATR\n手数 = 标准手数 × 调整因子'
                      : 'Adjustment Factor = Baseline ATR / Current ATR\nLot Size = Standard Lots × Adjustment Factor'}
                  </div>
                  <p className="font-bold mb-2 text-white">{isZh ? '示例：EUR/USD交易' : 'Example: EUR/USD Trading'}</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '基准ATR（过去30天平均）：60点' : 'Baseline ATR (30-day average): 60 pips'}</li>
                    <li className="text-gray-300">{isZh ? '标准仓位（2%风险）：0.7手' : 'Standard position (2% risk): 0.7 lots'}</li>
                    <li className="text-gray-300">{isZh ? '低波动日（ATR=40点）：0.7 × (60/40) = 1.05手' : 'Low volatility day (ATR=40): 0.7 × (60/40) = 1.05 lots'}</li>
                    <li className="text-gray-300">{isZh ? '高波动日（ATR=90点）：0.7 × (60/90) = 0.47手' : 'High volatility day (ATR=90): 0.7 × (60/90) = 0.47 lots'}</li>
                  </ul>
                </div>
                <p className="text-gray-300">
                  <strong className="text-white">{isZh ? '优势：' : 'Advantages:'}</strong>{' '}
                  {isZh
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-2 border-gray-800">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-gray-800 p-3 text-gray-300">
                          {isZh ? '正常状态' : 'Normal State'}
                        </td>
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">2%</td>
                        <td className="border border-gray-800 p-3 text-gray-300">
                      ...
                      <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                        ...
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">2.5%</td>
                        <td className="border border-gray-800 p-3 text-gray-300">
                      ...
                      <tr>
                        ...
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">1.5%</td>
                        <td className="border border-gray-800 p-3 text-gray-300">
                      ...
                      <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                        ...
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">1%</td>
                        <td className="border border-gray-800 p-3 text-gray-300">
                      ...
                      <tr>
                        ...
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">0.5-1%</td>
                        <td className="border border-gray-800 p-3 text-gray-300">
                      ...
                      <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                        ...
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">2-3%</td>
                        <td className="border border-gray-800 p-3 text-gray-300">
                ...
                <p className="mt-3">
                  <strong className="text-white">{isZh ? '注意：' : 'Note:'}</strong>{' '}
                  {isZh
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                  <p className="font-bold mb-2 text-white">{isZh ? '时段调整建议：' : 'Session Adjustment Recommendations:'}</p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li className="text-gray-300">
                      <strong className="text-white">{isZh ? '亚洲时段（GMT 00:00-08:00）：' : 'Asian Session (GMT 00:00-08:00):'}</strong>{' '}
                      {isZh ? '标准仓位 × 0.5-0.7（流动性低，假突破多）' : 'Standard position × 0.5-0.7 (low liquidity, many false breakouts)'}
                    </li>
                    <li className="text-gray-300">
                      <strong className="text-white">{isZh ? '伦敦时段（GMT 08:00-16:00）：' : 'London Session (GMT 08:00-16:00):'}</strong>{' '}
                      {isZh ? '标准仓位 × 1.0（流动性充足，趋势明确）' : 'Standard position × 1.0 (sufficient liquidity, clear trends)'}
                    </li>
                    <li className="text-gray-300">
                      <strong className="text-white">{isZh ? '纽约时段（GMT 13:00-21:00）：' : 'New York Session (GMT 13:00-21:00):'}</strong>{' '}
                      {isZh ? '标准仓位 × 1.0-1.2（流动性最大，波动性高）' : 'Standard position × 1.0-1.2 (highest liquidity, high volatility)'}
                    </li>
                    <li className="text-gray-300">
                      <strong className="text-white">{isZh ? '伦敦-纽约重叠（GMT 13:00-16:00）：' : 'London-NY Overlap (GMT 13:00-16:00):'}</strong>{' '}
                      {isZh ? '标准仓位 × 1.0（最佳交易时段）' : 'Standard position × 1.0 (best trading window)'}
                    </li>
                    <li className="text-gray-300">
                      <strong className="text-white">{isZh ? '重大新闻前后：' : 'Around Major News:'}</strong>{' '}
                  ...
                  <table className="w-full border-2 border-gray-800">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">1.0×</td>
                        <td className="border border-gray-800 p-3 text-gray-300">EUR/USD, GBP/USD, USD/JPY</td>
                      </tr>
                      <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                        <td className="border border-gray-800 p-3 text-gray-300">
                          {isZh ? '交叉盘（低波动）' : 'Crosses (Low Vol)'}
                        </td>
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">1.2×</td>
                        <td className="border border-gray-800 p-3 text-gray-300">EUR/CHF, EUR/GBP</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-800 p-3 text-gray-300">
                          {isZh ? '交叉盘（高波动）' : 'Crosses (High Vol)'}
                        </td>
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">0.6-0.8×</td>
                        <td className="border border-gray-800 p-3 text-gray-300">GBP/JPY, GBP/AUD, EUR/JPY</td>
                      </tr>
                      <tr className="bg-gray-50 dark:bg-[#0a0a0a]">
                        <td className="border border-gray-800 p-3 text-gray-300">
                          {isZh ? 'Exotic货币对' : 'Exotic Pairs'}
                        </td>
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">0.3-0.5×</td>
                        <td className="border border-gray-800 p-3 text-gray-300">USD/TRY, USD/ZAR, EUR/TRY</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-800 p-3 text-gray-300">
                          {isZh ? '商品货币对' : 'Commodity Pairs'}
                        </td>
                        <td className="border border-gray-800 p-3 font-bold text-gray-300 text-white">0.8-1.0×</td>
                        <td className="border border-gray-800 p-3 text-gray-300">AUD/USD, NZD/USD, USD/CAD</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm">
              <p className="font-bold text-white">{isZh ? '场景：' : 'Scenario:'}</p>
              <ul className="list-disc pl-6 space-y-1">
                <li className="text-gray-300">{isZh ? '账户：$10,000' : 'Account: $10,000'}</li>
                <li className="text-gray-300">{isZh ? '基础风险：2%（$200）' : 'Base Risk: 2% ($200)'}</li>
                <li className="text-gray-300">{isZh ? '货币对：GBP/JPY（高波动）' : 'Pair: GBP/JPY (high volatility)'}</li>
                <li className="text-gray-300">{isZh ? '时段：伦敦时段' : 'Session: London'}</li>
                <li className="text-gray-300">{isZh ? '当前ATR：120点（基准80点）' : 'Current ATR: 120 pips (baseline 80 pips)'}</li>
                <li className="text-gray-300">{isZh ? '账户状态：正常' : 'Account Status: Normal'}</li>
              </ul>
              <div className="p-3 bg-gray-50 dark:bg-black text-white font-mono text-xs mt-2">
                <p className="mb-2">{isZh ? '调整计算：' : 'Adjustment Calculation:'}</p>
                <p className="text-gray-300">Base Risk: $200</p>
                <p className="text-gray-300">Pair Adjustment: × 0.7 (GBP/JPY high vol)</p>
                <p className="text-gray-300">ATR Adjustment: × (80/120) = × 0.67</p>
                <p className="text-gray-300">Session Adjustment: × 1.0 (London)</p>
                <p className="mt-2">Final Risk = $200 × 0.7 × 0.67 × 1.0</p>
                <p className="font-bold text-white">= $93.8</p>
              </div>
              <p className="mt-2">
                {isZh
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <ul className="space-y-2 text-gray-300 dark:text-gray-300 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 制定明确规则：' : '1. Establish Clear Rules:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 避免过度复杂：' : '2. Avoid Over-Complexity:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 使用自动化工具：' : '3. Use Automation Tools:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 定期回测验证：' : '4. Regular Backtest Validation:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '5. 保留安全边际：' : '5. Maintain Safety Margin:'}</strong>{' '}
      ...
      <section id="case-studies" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300 text-sm">
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '交易者背景：' : 'Trader Background:'}</strong>{' '}
                {isZh
              ...
              <div className="p-4 bg-gray-50 dark:bg-black text-white">
                <p className="font-bold mb-2 text-white">{isZh ? '12个月交易记录：' : '12-Month Trading Record:'}</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">{isZh ? '总交易：280笔' : 'Total Trades: 280'}</li>
                  <li className="text-gray-300">{isZh ? '胜率：48%（134胜146负）' : 'Win Rate: 48% (134 wins, 146 losses)'}</li>
                  <li className="text-gray-300">{isZh ? '平均盈亏比：1:2.2' : 'Average Risk-Reward: 1:2.2'}</li>
                  <li className="text-gray-300">{isZh ? '最大单笔盈利：$420' : 'Largest Win: $420'}</li>
                  <li className="text-gray-300">{isZh ? '最大单笔亏损：$178（始终<2%）' : 'Largest Loss: $178 (always <2%)'}</li>
                  <li className="text-gray-300">{isZh ? '最大回撤：12%（3周）' : 'Max Drawdown: 12% (3 weeks)'}</li>
                  <li className="text-gray-300">{isZh ? '月均收益率：4.2%' : 'Monthly Average Return: 4.2%'}</li>
              ...
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '关键成功因素：' : 'Key Success Factors:'}</strong>
              </p>
              <ol className="list-decimal pl-6 space-y-2">
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '严格执行2%规则：' : 'Strict 2% Rule Execution:'}</strong>{' '}
                  {isZh ? '280笔交易，每笔风险始终在1.8-2.1%之间，从未超过2.5%。' : '280 trades, every trade risk consistently between 1.8-2.1%, never exceeded 2.5%.'}
                </li>
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? 'ATR动态调整：' : 'ATR Dynamic Adjustment:'}</strong>{' '}
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '复利增长：' : 'Compound Growth:'}</strong>{' '}
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '回撤管理：' : 'Drawdown Management:'}</strong>{' '}
              ...
              <p className="mt-3 p-3 bg-green-100 dark:bg-green-900/30 border-2 border-green-600">
                <strong className="text-white">{isZh ? '启示：' : 'Insight:'}</strong>{' '}
                {isZh
          ...
          <div className="p-6 border-2 border-red-600 bg-red-50 dark:bg-red-900/20">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300 text-sm">
              ...
              <div className="p-4 bg-gray-50 dark:bg-black text-white">
                <p className="font-bold mb-2 text-white">{isZh ? '5个月灾难性记录：' : '5-Month Disastrous Record:'}</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">{isZh ? '第1个月：盈利$1,800（账户$13,800）' : 'Month 1: Profit $1,800 (account $13,800)'}</li>
                  <li className="text-gray-300">{isZh ? '感觉良好，第2个月仓位从1手增至2-3手' : 'Feeling good, month 2 position increased from 1 lot to 2-3 lots'}</li>
                  <li className="text-gray-300">{isZh ? '第2个月：单笔亏损$1,200（风险约9%）' : 'Month 2: Single loss $1,200 (risk ~9%)'}</li>
                  <li className="text-gray-300">{isZh ? '不服气，第3个月开5手想"快速回本"' : 'Refused to accept, month 3 opened 5 lots to "quickly recover"'}</li>
                  <li className="text-gray-300">{isZh ? '第3个月：连续2笔巨亏，$3,500（账户跌至$9,100）' : 'Month 3: 2 consecutive large losses, $3,500 (account fell to $9,100)'}</li>
                  <li className="text-gray-300">{isZh ? '恐慌中第4-5个月：随意交易，仓位混乱' : 'Panic months 4-5: random trading, chaotic position sizing'}</li>
              ...
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '失败原因剖析：' : 'Failure Analysis:'}</strong>
              </p>
              <ol className="list-decimal pl-6 space-y-2">
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '无固定风险管理：' : 'No Fixed Risk Management:'}</strong>{' '}
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '情绪化交易：' : 'Emotional Trading:'}</strong>{' '}
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '忽视复利反向效应：' : 'Ignored Reverse Compound Effect:'}</strong>{' '}
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '缺乏止损机制：' : 'Lacked Stop-Loss Mechanism:'}</strong>{' '}
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '策略相同，结果天壤之别：' : 'Same Strategy, Vastly Different Results:'}</strong>{' '}
              ...
              <p className="mt-3 p-3 bg-red-100 dark:bg-red-900/30 border-2 border-red-600">
                <strong className="text-white">{isZh ? '教训：' : 'Lesson:'}</strong>{' '}
                {isZh
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={index} className="p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
              ...
              <p className="text-gray-300 dark:text-gray-300 mb-3 text-sm">
                <strong className="text-white">{isZh ? '问题：' : 'Problem:'}</strong> {item.problem}
              </p>
        ...
        <div className="space-y-6">
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '实施方法：' : 'Implementation:'}</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '第1批（50%仓位）：' : 'Batch 1 (50% position):'}</strong>{' '}
                    {isZh ? '在初始信号出现时建仓，止损设置在关键技术位' : 'Enter at initial signal, stop at key technical level'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '第2批（30%仓位）：' : 'Batch 2 (30% position):'}</strong>{' '}
                    {isZh ? '价格突破前高/低确认趋势时加仓，第1批止损移至盈亏平衡' : 'Add when price breaks previous high/low confirming trend, move batch 1 stop to breakeven'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '第3批（20%仓位）：' : 'Batch 3 (20% position):'}</strong>{' '}
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '相关性控制原则：' : 'Correlation Control Principles:'}</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li className="text-gray-300">
                    {isZh
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '推荐设置：' : 'Recommended Settings:'}</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '保守型：' : 'Conservative:'}</strong>{' '}
                    {isZh ? '最大总风险5%（最多2-3个仓位）' : 'Maximum total risk 5% (max 2-3 positions)'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '平衡型：' : 'Balanced:'}</strong>{' '}
                    {isZh ? '最大总风险8%（最多3-4个仓位）' : 'Maximum total risk 8% (max 3-4 positions)'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '激进型：' : 'Aggressive:'}</strong>{' '}
                    {isZh ? '最大总风险10%（最多4-5个仓位）' : 'Maximum total risk 10% (max 4-5 positions)'}
                  </li>
                </ul>
              </div>
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '实施：' : 'Implementation:'}</strong>{' '}
                {isZh
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="space-y-2">
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '1. FX Killer Position Calculator：' : '1. FX Killer Position Calculator:'}</strong>{' '}
                  {isZh
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '2. Position Sizing EA：' : '2. Position Sizing EA:'}</strong>{' '}
                  {isZh
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '3. Excel仓位管理表：' : '3. Excel Position Management Sheet:'}</strong>{' '}
                  {isZh
                ...
                <li className="text-gray-300">
                  <strong className="text-white">{isZh ? '4. 相关性矩阵工具：' : '4. Correlation Matrix Tool:'}</strong>{' '}
                  {isZh
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <ul className="space-y-2 text-gray-300 dark:text-gray-300 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 定期审计仓位管理：' : '1. Regular Position Management Audit:'}</strong>{' '}
                {isZh ? '每季度分析实际风险是否符合计划，是否有违规超仓情况。' : 'Quarterly analyze if actual risk matches plan, any violation overleveraging.'}
              </li>
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 回测不同仓位方法：' : '2. Backtest Different Position Methods:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 账户分层管理：' : '3. Tiered Account Management:'}</strong>{' '}
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 持续优化调整规则：' : '4. Continuously Optimize Adjustment Rules:'}</strong>{' '}

    ...
    <EducationPageTemplate content={content} language={lang}>
      ...
      <section id="what-is-breakout" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-4 text-gray-300 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '突破交易的核心概念' : 'Core Concepts of Breakout Trading'}</h3>
            <ul className="space-y-3">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. 价格盘整与能量积累：' : '1. Price Consolidation and Energy Accumulation:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 突破=趋势启动信号：' : '2. Breakout = Trend Initiation Signal:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 跟随效应：' : '3. Follow-Through Effect:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 回测现象：' : '4. Retest Phenomenon:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '5. 假突破陷阱：' : '5. False Breakout Trap:'}</strong>{' '}
                {isZh
          ...
          <div className="p-6 bg-gray-50 dark:bg-[#0a0a0a] border-2 border-gray-800 dark:border-gray-700">
            ...
            <div className="space-y-3 text-sm">
              <div>
                <p className="font-bold mb-2 text-white">{isZh ? '场景1：区间突破（最常见）' : 'Scenario 1: Range Breakout (Most Common)'}</p>
                <p className="text-gray-300">
                  {isZh
              ...
              <div>
                <p className="font-bold mb-2 text-white">{isZh ? '场景2：趋势线突破' : 'Scenario 2: Trendline Breakout'}</p>
                <p className="text-gray-300">
                  {isZh
              ...
              <div>
                <p className="font-bold mb-2 text-white">{isZh ? '场景3：整数关口突破' : 'Scenario 3: Round Number Breakout'}</p>
                <p className="text-gray-300">
                  {isZh
              ...
              <div>
                <p className="font-bold mb-2 text-white">{isZh ? '场景4：新闻突破' : 'Scenario 4: News Breakout'}</p>
                <p className="text-gray-300">
                  {isZh
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '适用各种时间框架：' : 'Applicable to All Timeframes:'}</strong>{' '}
          ...
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '假突破频繁：' : 'Frequent False Breakouts:'}</strong>{' '}
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <div className="space-y-2 text-sm">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li className="text-gray-300">{isZh ? '喜欢快节奏、爆发性行情的交易者' : 'Traders who enjoy fast-paced, explosive moves'}</li>
                <li className="text-gray-300">{isZh ? '能快速决策、果断执行的交易者' : 'Traders capable of quick decisions and decisive execution'}</li>
                <li className="text-gray-300">{isZh ? '有耐心等待明确突破信号的交易者' : 'Traders patient enough to wait for clear breakout signals'}</li>
                <li className="text-gray-300">{isZh ? '能承受30-50%胜率但追求高盈亏比的交易者' : 'Traders who can accept 30-50% win rate but pursue high reward-risk'}</li>
                <li className="text-gray-300">{isZh ? '新手和中级交易者（策略相对简单）' : 'Beginners and intermediate traders (relatively simple strategy)'}</li>
              </ul>
              <p className="mt-3">
                <strong className="text-red-600 dark:text-red-400">{isZh ? '❌ 不适合：' : '❌ Not Suitable For:'}</strong>
              </p>
              <ul className="list-disc pl-6 space-y-1">
                <li className="text-gray-300">{isZh ? '无法承受频繁假突破和止损的交易者' : 'Traders cannot bear frequent false breakouts and stops'}</li>
                <li className="text-gray-300">{isZh ? '追求高胜率、低风险的保守交易者' : 'Conservative traders pursuing high win rate and low risk'}</li>
                <li className="text-gray-300">{isZh ? '情绪容易波动、易冲动的交易者' : 'Traders with unstable emotions, easily impulsive'}</li>
                <li className="text-gray-300">{isZh ? '没有时间盯盘、无法快速反应的交易者' : 'Traders without time to monitor, cannot react quickly'}</li>
              </ul>
      ...
      <section id="breakout-types" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-300 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '类型1：水平区间突破（最可靠）' : 'Type 1: Horizontal Range Breakout (Most Reliable)'}</h3>
            <div className="space-y-3">
              ...
              <div className="p-4 bg-[#0a0a0a] dark:bg-gray-900">
                <p className="font-bold mb-2 text-white">{isZh ? '识别特征：' : 'Identification Features:'}</p>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '1. 明确的区间边界：' : '1. Clear Range Boundaries:'}</strong>{' '}
                    {isZh ? '至少2次触及上沿和下沿，边界水平清晰' : 'At least 2 touches of top and bottom, boundaries horizontally clear'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '2. 持续时间：' : '2. Duration:'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '3. 区间高度：' : '3. Range Height:'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '4. 突破确认：' : '4. Breakout Confirmation:'}</strong>{' '}
                    {isZh ? '收盘价明确突破区间边界至少10-20点' : 'Close price clearly breaks range boundary by at least 10-20 pips'}
                  </li>
                </ul>
              </div>
              <div className="p-4 bg-green-900/30 dark:bg-green-900/20 border-2 border-green-600 mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '交易规则：' : 'Trading Rules:'}</p>
                <ul className="space-y-1 text-sm">
                  <li className="text-gray-300"><strong className="text-white">{isZh ? '入场：' : 'Entry:'}</strong> {isZh ? '突破K线收盘后，下一根K线开盘入场，或等待回测突破位后入场' : 'After breakout candle closes, enter at next candle open, or enter after retest of breakout level'}</li>
                  <li className="text-gray-300"><strong className="text-white">{isZh ? '止损：' : 'Stop:'}</strong> {isZh ? '区间另一边界，或突破位下方20-30点' : 'Opposite range boundary, or 20-30 pips below breakout level'}</li>
                  <li className="text-gray-300"><strong className="text-white">{isZh ? '止盈：' : 'Target:'}</strong> {isZh ? '区间高度的1-2倍' : '1-2x range height'}</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                  <p className="font-bold mb-2 text-white">{isZh ? '上升趋势线突破（做空）：' : 'Ascending Trendline Break (Short):'}</p>
                  <ul className="space-y-1">
                    <li className="text-gray-300">{isZh ? '价格在上升趋势线上方运行' : 'Price runs above ascending trendline'}</li>
                    <li className="text-gray-300">{isZh ? '突然跌破趋势线，收盘在趋势线下方' : 'Suddenly breaks below trendline, closes below'}</li>
                    <li className="text-gray-300">{isZh ? '可能回测趋势线后继续下跌' : 'May retest trendline then continue falling'}</li>
                    <li className="text-gray-300">{isZh ? '入场：跌破趋势线后，或回测趋势线失败后' : 'Entry: After breaking trendline, or after failed retest'}</li>
                  </ul>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                  <p className="font-bold mb-2 text-white">{isZh ? '下降趋势线突破（做多）：' : 'Descending Trendline Break (Long):'}</p>
                  <ul className="space-y-1">
                    <li className="text-gray-300">{isZh ? '价格在下降趋势线下方运行' : 'Price runs below descending trendline'}</li>
                    <li className="text-gray-300">{isZh ? '突然突破趋势线，收盘在趋势线上方' : 'Suddenly breaks above trendline, closes above'}</li>
                    <li className="text-gray-300">{isZh ? '可能回测趋势线后继续上涨' : 'May retest trendline then continue rising'}</li>
                    <li className="text-gray-300">{isZh ? '入场：突破趋势线后，或回测趋势线成功后' : 'Entry: After breaking trendline, or after successful retest'}</li>
                  </ul>
                </div>
              </div>
              <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600 mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '⚠️ 重要提示：' : '⚠️ Important Note:'}</p>
                <p className="text-gray-300">
                  {isZh
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '突破前高做多（上升趋势延续）：' : 'Break Above Previous High Long (Uptrend Continuation):'}</p>
                <ul className="space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '背景：' : 'Context:'}</strong>{' '}
                    {isZh ? 'H4或D1确认上升趋势（价格在20/50 EMA上方）' : 'H4 or D1 confirm uptrend (price above 20/50 EMA)'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '信号：' : 'Signal:'}</strong>{' '}
                    {isZh ? '价格回调后再次上涨，突破前一个摆动高点' : 'Price pulls back then rises again, breaks above previous swing high'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '入场：' : 'Entry:'}</strong>{' '}
                    {isZh ? '突破前高后，下一根K线开盘价入场' : 'After breaking previous high, enter at next candle open'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '止损：' : 'Stop:'}</strong>{' '}
                    {isZh ? '最近回调低点下方，或前高下方30点' : 'Below recent pullback low, or 30 pips below previous high'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '止盈：' : 'Target:'}</strong>{' '}
              ...
              <div className="p-4 bg-green-50 dark:bg-green-900/20 border-2 border-green-600 mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '优势：' : 'Advantages:'}</p>
                <ul className="space-y-1">
                  <li className="text-gray-300">{isZh ? '顺势交易，胜率较高（55-65%）' : 'With-trend trading, higher win rate (55-65%)'}</li>
                  <li className="text-gray-300">{isZh ? '止损相对较小，风险回报比优秀' : 'Relatively small stop, excellent risk-reward'}</li>
                  <li className="text-gray-300">{isZh ? '心理负担小，符合"趋势是朋友"理念' : 'Low psychological burden, aligns with "trend is friend" philosophy'}</li>
                  <li className="text-gray-300">{isZh ? '适合新手和中级交易者' : 'Suitable for beginners and intermediate traders'}</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="font-bold mt-3 text-white">{isZh ? '重要关口：' : 'Key Levels:'}</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">{isZh ? '大整数：1.1000、1.2000' : 'Major rounds: 1.1000, 1.2000'}</li>
                  <li className="text-gray-300">{isZh ? '50点关口：1.0950、148.50' : '50-pip levels: 1.0950, 148.50'}</li>
                  <li className="text-gray-300">{isZh ? '心理关口：1.1000、150.00' : 'Psychological levels: 1.1000, 150.00'}</li>
                </ul>
                <p className="mt-3">
                  <strong className="text-white">{isZh ? '特点：' : 'Features:'}</strong>{' '}
            ...
            <div className="p-6 border-2 border-gray-800">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-gray-300">
                  <strong className="text-white">{isZh ? '常见形态：' : 'Common Patterns:'}</strong>
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '三角形：' : 'Triangles:'}</strong>{' '}
                    {isZh ? '上升/下降/对称三角形突破' : 'Ascending/descending/symmetrical triangle breaks'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '旗形：' : 'Flags:'}</strong>{' '}
                    {isZh ? '强势上涨后短暂回调形成旗形，向上突破' : 'Brief pullback after strong rise forms flag, breaks upward'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '楔形：' : 'Wedges:'}</strong>{' '}
                    {isZh ? '上升/下降楔形突破' : 'Rising/falling wedge breaks'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '头肩顶/底：' : 'Head and Shoulders:'}</strong>{' '}
                    {isZh ? '突破颈线' : 'Neckline break'}
                  </li>
                </ul>
                <p className="mt-3">
                  <strong className="text-white">{isZh ? '优势：' : 'Advantage:'}</strong>{' '}
      ...
      <section id="entry-timing" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '策略1：激进入场 - 突破K线收盘确认' : 'Strategy 1: Aggressive Entry - Breakout Candle Close Confirmation'}</h3>
            <div className="space-y-3">
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '方法：' : 'Method:'}</strong>{' '}
                {isZh
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '不错过强势突破，抓住最佳入场价格' : 'Don\'t miss strong breakouts, catch best entry price'}</li>
                    <li className="text-gray-300">{isZh ? '适合爆发性行情，单笔利润空间大' : 'Suitable for explosive moves, large per-trade profit potential'}</li>
                    <li className="text-gray-300">{isZh ? '心理压力小，不会懊悔"错过机会"' : 'Low psychological pressure, won\'t regret "missing opportunity"'}</li>
                  </ul>
                </div>
                <div>
                  <p className="font-bold mb-2 text-red-400 dark:text-red-600">{isZh ? '❌ 劣势：' : '❌ Disadvantages:'}</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '假突破概率高，可能频繁止损' : 'High false breakout probability, may stop out frequently'}</li>
                    <li className="text-gray-300">{isZh ? '风险回报比相对较差' : 'Relatively poor risk-reward ratio'}</li>
                    <li className="text-gray-300">{isZh ? '需要快速反应和执行' : 'Requires quick reaction and execution'}</li>
                  </ul>
                </div>
              </div>
              <div className="p-4 bg-[#0a0a0a] dark:bg-gray-900 mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '具体规则：' : 'Specific Rules:'}</p>
                <ol className="list-decimal pl-6 space-y-1 text-sm text-gray-300">
                  <li className="text-gray-300">{isZh ? '等待突破K线完全收盘（不要在K线形成中入场）' : 'Wait for breakout candle to fully close (don\'t enter during candle formation)'}</li>
                  <li className="text-gray-300">{isZh ? '收盘价必须在突破位之上/下至少10-20点' : 'Close must be at least 10-20 pips above/below breakout level'}</li>
                  <li className="text-gray-300">{isZh ? '突破K线实体应大于影线（实体>5点）' : 'Breakout candle body should be larger than shadow (body >5 pips)'}</li>
                  <li className="text-gray-300">{isZh ? '下一根K线开盘立即入场（使用市价单或挂单）' : 'Enter immediately at next candle open (use market or pending order)'}</li>
                  <li className="text-gray-300">{isZh ? '止损设在突破位下方/上方20-30点' : 'Stop set 20-30 pips below/above breakout level'}</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a] text-sm">
                <p className="font-bold mb-2 text-white">{isZh ? '回测的三种情况：' : 'Three Retest Scenarios:'}</p>
                <ul className="space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '1. 完美回测（最佳）：' : '1. Perfect Retest (Best):'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '2. 浅回测：' : '2. Shallow Retest:'}</strong>{' '}
                    {isZh ? '价格小幅回调但未触及突破位，距离突破位10-20点时反弹' : 'Price pulls back slightly but doesn\'t touch breakout level, bounces 10-20 pips away'}
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '3. 无回测：' : '3. No Retest:'}</strong>{' '}
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4 text-sm">
                <div className="p-4 bg-green-50 dark:bg-green-900/20 border-2 border-green-600">
                  <p className="font-bold mb-2 text-white">{isZh ? '✅ 优势：' : '✅ Advantages:'}</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '避免大部分假突破，胜率提升至60-70%' : 'Avoids most false breakouts, win rate increases to 60-70%'}</li>
                    <li className="text-gray-300">{isZh ? '入场价格更好，风险回报比优秀' : 'Better entry price, excellent risk-reward ratio'}</li>
                    <li className="text-gray-300">{isZh ? '心理负担小，更有信心持仓' : 'Low psychological burden, more confidence holding position'}</li>
                    <li className="text-gray-300">{isZh ? '适合新手和中级交易者' : 'Suitable for beginners and intermediate traders'}</li>
                  </ul>
                </div>
                <div className="p-4 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
                  <p className="font-bold mb-2 text-white">{isZh ? '❌ 劣势：' : '❌ Disadvantages:'}</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li className="text-gray-300">{isZh ? '可能错过强势突破（30-40%突破不回测）' : 'May miss strong breakouts (30-40% don\'t retest)'}</li>
                    <li className="text-gray-300">{isZh ? '需要耐心等待，考验情绪控制' : 'Requires patient waiting, tests emotional control'}</li>
                    <li className="text-gray-300">{isZh ? '回测时间不确定，可能等待数小时或数天' : 'Retest timing uncertain, may wait hours or days'}</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <div className="space-y-3 text-gray-300 dark:text-gray-300 text-sm">
              ...
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a]">
                <p className="font-bold mb-2 text-white">{isZh ? '具体执行步骤：' : 'Specific Execution Steps:'}</p>
                <ol className="list-decimal pl-6 space-y-2">
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '第一笔（50%仓位）：' : 'First Position (50%):'}</strong>{' '}
                  ...
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '第二笔（50%仓位）：' : 'Second Position (50%):'}</strong>
                    <ul className="list-circle pl-6 mt-1">
                      <li className="text-gray-300">{isZh ? '如果价格回测突破位，在回测成功后入场第二笔50%' : 'If price retests breakout level, enter second 50% after successful retest'}</li>
                      <li className="text-gray-300">{isZh ? '如果价格不回测直接上涨，放弃第二笔，只持有第一笔' : 'If price doesn\'t retest and rises directly, skip second position, only hold first'}</li>
                    </ul>
                  </li>
                  <li className="text-gray-300">
                    <strong className="text-white">{isZh ? '止损调整：' : 'Stop Adjustment:'}</strong>{' '}
                    {isZh ? '第二笔入场后，将两笔止损都移至突破位下方/上方20点' : 'After second entry, move both stops to 20 pips below/above breakout level'}
                  </li>
                </ol>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-[#0a0a0a] border-2 border-[#ff102a] mt-3">
                <p className="font-bold mb-2 text-white">{isZh ? '优势：' : 'Advantages:'}</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="text-gray-300">{isZh ? '平衡激进和保守，不错过机会也不冒过大风险' : 'Balances aggressive and conservative, doesn\'t miss opportunities nor take excessive risk'}</li>
                  <li className="text-gray-300">{isZh ? '第一笔抓住强势突破，第二笔降低平均成本' : 'First catches strong breakout, second reduces average cost'}</li>
                  <li className="text-gray-300">{isZh ? '心理灵活，适应不同市场情况' : 'Psychological flexibility, adapts to different market conditions'}</li>
                  <li className="text-gray-300">{isZh ? '适合有经验的交易者' : 'Suitable for experienced traders'}</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <div className="space-y-2 text-sm text-gray-300 dark:text-gray-300">
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '新手（0-1年经验）：' : 'Beginners (0-1 year experience):'}</strong>{' '}
              ...
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '中级（1-3年经验）：' : 'Intermediate (1-3 years experience):'}</strong>{' '}
              ...
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '高级（3年以上经验）：' : 'Advanced (3+ years experience):'}</strong>{' '}
        ...
        <div className="space-y-6">
          <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
            ...
            <div className="space-y-2 text-gray-300 dark:text-gray-300 text-sm">
              ...
              <p className="text-gray-300">
                <strong className="text-white">{isZh ? '突破执行：' : 'Breakout Execution:'}</strong>
              </p>
              <ul className="list-disc pl-6 space-y-1">
                <li className="text-gray-300">{isZh ? '1月12日20:00，欧美重叠时段，大阳线突破1.0950，收盘1.0965' : 'Jan 12, 20:00, EU-US overlap, large bullish candle breaks 1.0950, closes 1.0965'}</li>
                <li className="text-gray-300">{isZh ? '突破K线实体15点，无长上影线，显示买盘强劲' : 'Breakout candle body 15 pips, no long upper shadow, shows strong buying'}</li>
                <li className="text-gray-300">{isZh ? '入场：使用保守策略，等待回测。1月13日08:00，价格回测1.0955，出现看涨锤子线' : 'Entry: Using conservative strategy, wait for retest. Jan 13, 08:00, price retests 1.0955, bullish hammer appears'}</li>
                <li className="text-gray-300">{isZh ? '入场价：1.0960（回测后反弹）' : 'Entry: 1.0960 (bounce after retest)'}</li>
                <li className="text-gray-300">{isZh ? '止损：1.0920（区间上沿下方30点）' : 'Stop: 1.0920 (30 pips below range top)'}</li>
                <li className="text-gray-300">{isZh ? '目标：1.1060（区间高度100点）' : 'Target: 1.1060 (100 pip range height)'}</li>
              </ul>
              <p className="text-gray-300">
          ...
          <div className="p-6 border-2 border-red-600 bg-red-50 dark:bg-red-900/20">
            ...
            <div className="space-y-2 text-gray-300 dark:text-gray-300 text-sm">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li className="text-gray-300">{isZh ? '在低流动性时段（亚洲午间）' : 'During low liquidity session (Asian afternoon)'}</li>
                <li className="text-gray-300">{isZh ? '区间太窄（50点）且盘整时间太短（30分钟）' : 'Range too narrow (50 pips) and consolidation too short (30 minutes)'}</li>
                <li className="text-gray-300">{isZh ? '突破K线带长上影线（上影线10点，实体5点）' : 'Breakout candle has long upper shadow (10 pip shadow, 5 pip body)'}</li>
                <li className="text-gray-300">{isZh ? '交易者使用激进策略，187.55入场做多' : 'Trader used aggressive strategy, entered long at 187.55'}</li>
                <li className="text-gray-300">{isZh ? '止损187.30（25点）' : 'Stop 187.30 (25 pips)'}</li>
              </ul>
              <p className="text-gray-300">
      ...
      <section id="false-breakout" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-300 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 text-gray-300 border-2 border-gray-800">
            <h3 className="text-xl font-bold mb-4 text-white">{isZh ? '假突破的典型特征' : 'Typical False Breakout Characteristics'}</h3>
            <ul className="space-y-3 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '1. K线形态警告：' : '1. Candle Pattern Warning:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '2. 收盘价未能站稳：' : '2. Close Fails to Hold:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '3. 成交量不配合：' : '3. No Volume Confirmation:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '4. 快速回撤：' : '4. Quick Retracement:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '5. 错误时段：' : '5. Wrong Session:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '6. 盘整不充分：' : '6. Inadequate Consolidation:'}</strong>{' '}
                {isZh
          ...
          <div className="p-6 border-2 border-gray-800">
            ...
            <ol className="list-decimal pl-6 space-y-3 text-sm">
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '等待收盘确认：' : 'Wait for Close Confirmation:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '检查K线质量：' : 'Check Candle Quality:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '确认盘整质量：' : 'Confirm Consolidation Quality:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '选择最佳时段：' : 'Choose Best Sessions:'}</strong>{' '}
                {isZh
              ...
              <li className="text-gray-300">
                <strong className="text-white">{isZh ? '配合趋势方向：' : 'Align With Trend:'}</strong>{' '}
                {isZh

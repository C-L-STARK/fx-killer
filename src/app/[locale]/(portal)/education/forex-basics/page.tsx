  ...
  return (
    <EducationPageTemplate content={content} language={lang}>
            ...
            <table className="w-full border-2 border-gray-800">
              <thead>
                <tr className="bg-gray-900 text-gray-300">
                  <th className="border-2 border-gray-800 px-4 py-3 text-left font-bold text-white">
              ...
              <tbody className="text-gray-300 dark:text-gray-300">
                <tr>
                  <td className="border-2 border-gray-800 px-4 py-3 font-bold text-white">
                    {isZh ? '悉尼时段' : 'Sydney Session'}
                  </td>
                  <td className="border-2 border-gray-800 px-4 py-3">06:00 - 15:00</td>
                ...
                <tr className="bg-gray-50 dark:bg-black">
                  ...
                  <td className="border-2 border-gray-800 px-4 py-3">08:00 - 16:00</td>
                  <td className="border-2 border-gray-800 px-4 py-3">
                ...
                <tr>
                  ...
                  <td className="border-2 border-gray-800 px-4 py-3">15:30 - 00:30</td>
                  <td className="border-2 border-gray-800 px-4 py-3">
                ...
                <tr className="bg-gray-50 dark:bg-black">
                  ...
                  <td className="border-2 border-gray-800 px-4 py-3">20:30 - 05:00</td>
                  <td className="border-2 border-gray-800 px-4 py-3">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-gray-900 text-gray-300 p-6 my-6 border-2 border-gray-800">
            ...
            <div className="space-y-3">
              ...
              <p className="mt-4">
                <strong className="text-white">{isZh ? '示例：EUR/USD = 1.1000' : 'Example: EUR/USD = 1.1000'}</strong>
              </p>
              <p className="mb-0">
          ...
          <div className="space-y-6 mb-8">
            <div className="border-l-4 border-gray-800 pl-6">
              ...
              <ul className="grid md:grid-cols-2 gap-2 list-none">
                <li className="text-gray-300 dark:text-gray-300">
      ...
      <section id="key-terms" className="mb-16 scroll-mt-20">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="border-2 border-gray-800 p-5 bg-red-50 dark:bg-red-950">
              <h4 className="text-lg font-bold mb-2 text-white">
      ...
      <section id="practical-tips" className="mb-16 scroll-mt-20">
        ...
        <div className="prose prose-lg max-w-none">
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-900 text-gray-300 p-6 border-2 border-gray-800">
              <h3 className="text-xl font-bold mb-4 text-white">
                {isZh ? '✅ 应该做的' : '✅ Do These'}
              </h3>
            ...
            <div className="bg-red-50 dark:bg-red-950 p-6 border-2 border-red-600">
              ...
              <ul className="space-y-3 list-none text-gray-300 dark:text-gray-300">
                <li className="flex items-start gap-2">
                  <span className="font-bold text-white">•</span>
                  <span className="text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-black border-2 border-gray-800 p-8 my-8">

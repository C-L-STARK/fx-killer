...
export default function CalendlyWidget() {
  ...
  return (
    <button
      ...
      className="fixed right-6 bottom-44 z-40 bg-gradient-to-br from-[#ff102a] to-black text-white p-3 border-2 border-[#ff102a] shadow-2xl hover:scale-110 transition-transform"

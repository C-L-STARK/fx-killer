...
export default function DonateSection() {
    const [modalType, setModalType] = useState<'interview' | 'membership'>('interview');
    ...
    const openModal = (type: 'interview' | 'membership') => {
        setModalType(type);
        setIsEmailModalOpen(true);
    };

    return (
        <div className="w-full bg-black text-white font-sans selection:bg-[#ff102a] selection:text-white overflow-x-hidden">
            ...
            <section className="relative py-32 flex flex-col items-center justify-center overflow-hidden">
                ...
                {/* Scroll Indicator - Removed as it's not a full page hero anymore */}
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(250px,auto)]">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="md:col-span-2 bg-[#0a0a0a] border border-gray-900 p-10 hover:border-[#ff102a]/50 transition-all duration-500 group relative overflow-hidden"
                        >
                        ...
                        <motion.div
                            ...
                            className="md:row-span-2 bg-[#0a0a0a] border border-gray-900 p-10 hover:border-[#ff102a]/50 transition-all duration-500 group relative overflow-hidden flex flex-col justify-between"
                        >
                        ...
                        <motion.div
                            ...
                            className="bg-[#0a0a0a] border border-gray-900 p-10 hover:border-[#ff102a]/50 transition-all duration-500 group"
                        >
                        ...
                        <motion.div
                            ...
                            className="bg-[#ff102a] p-10 text-white relative overflow-hidden group"
                        >
            ...
            <section className="py-32 px-6 relative overflow-hidden">
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    {/* Membership label and title removed per user request */}
                    ...
                    >
                        <div className="bg-gradient-to-br from-[#1a1a1a] to-black border border-[#333] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden group hover:shadow-[0_20px_50px_rgba(255,16,42,0.15)] transition-shadow duration-500">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {loadingAddress ? (
                                        <div className="h-16 bg-[#0a0a0a] animate-pulse"></div>
                                    ) : (
                                        <div
                                            onClick={copyToClipboard}
                                            className="bg-[#050505] border border-gray-800 p-4 md:p-6 flex items-center justify-between cursor-pointer hover:border-[#ff102a] transition-colors group/wallet"
                                        >
